...
JDSpellAnnounceFrame:UnregisterEvent("PARTY_INVITE_REQUEST")
...
JDSpellAnnounceFrame:UnregisterEvent("SCREENSHOT_SUCCEEDED")
...
JDSpellAnnounceFrame:UnregisterEvent("UNIT_PET")
JDSpellAnnounceFrame:UnregisterEvent("START_LOOT_ROLL")
JDSpellAnnounceFrame:UnregisterEvent("CANCEL_LOOT_ROLL")
JDSpellAnnounceFrame:UnregisterEvent("UNIT_DISPLAYPOWER")
JDSpellAnnounceFrame:UnregisterEvent("UNIT_PET_TRAINING_POINTS")
JDSpellAnnounceFrame:UnregisterEvent("UNIT_PET_EXPERIENCE")
JDSpellAnnounceFrame:UnregisterEvent("UNIT_MAXFOCUS")
